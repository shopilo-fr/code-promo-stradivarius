#!/usr/bin/env python3
"""
Recuperation des codes promo Stradivarius depuis shopilo.fr
Sursa: https://shopilo.fr/reductions/stradivarius.com
"""
...
SHOPILO_URL = "https://shopilo.fr/reductions/stradivarius.com"
STORE_NAME = "Stradivarius"


def fetch_coupons(url=SHOPILO_URL):
    """Renvoie la liste des coupons actifs pour Stradivarius depuis shopilo.fr"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-fr/code-promo-stradivarius)"
    }
    try:
